...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-[240px] bg-[var(--gt-navy)] flex flex-col z-40">
      {/* Logo */}
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[10px] uppercase tracking-wider text-[var(--gt-red)] font-semibold">Admin</span>
          </div>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-6 py-2.5 text-sm transition-colors ${
                isActive
                  ? "text-white bg-white/10 border-r-2 border-[var(--gt-red)]"
